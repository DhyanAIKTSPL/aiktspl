      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get in touch with our team. We're here to help with any questions about AIKSHETRA.
          </p>
        </motion.div>
          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@aikshetra.com</p>
                    <p className="text-gray-600">support@aikshetra.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-blue-100 p-3 rounded-lg hover:bg-blue-200 transition-colors">
